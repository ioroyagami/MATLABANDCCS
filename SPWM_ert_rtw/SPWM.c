...
void SPWM_Subsystem_Reset(void)
{
  /* InitializeConditions for Delay: '<S1>/Delay' */
  SPWM_DW.Delay_DSTATE = SPWM_P.Delay_InitialCondition;
}
...
void SPWM_Subsystem_Start(void)
{
...
void SPWM_Subsystem(void)
{
  ...
  rtb_SineWaveFunction = sin(SPWM_P.SineWaveFunction_Freq * rtb_Delay +
    SPWM_P.SineWaveFunction_Phase) * SPWM_P.SineWaveFunction_Amp +
    SPWM_P.SineWaveFunction_Bias;
